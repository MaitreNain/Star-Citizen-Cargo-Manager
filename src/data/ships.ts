...
export const ships: Ship[] = [
...

  {
    ...
    cargoBays: [
      // Groupe haut (z=4)
      { id: "hull-b-bay-1",  name: "Soute 1",  size: { x: 2, y: 8, z: 2 }, offset: { x: -2, y: 0,  z: 4 } },
      { id: "hull-b-bay-2",  name: "Soute 2",  size: { x: 2, y: 8, z: 2 }, offset: { x: 0,  y: 0,  z: 4 } },
      { id: "hull-b-bay-3",  name: "Soute 3",  size: { x: 2, y: 8, z: 2 }, offset: { x: -2, y: -9, z: 4 } },
      { id: "hull-b-bay-4",  name: "Soute 4",  size: { x: 2, y: 8, z: 2 }, offset: { x: 0,  y: -9, z: 4 } },
      // Groupe gauche (z=2)
      { id: "hull-b-bay-5",  name: "Soute 5",  size: { x: 2, y: 8, z: 2 }, offset: { x: -6, y: 0,  z: 2 } },
      { id: "hull-b-bay-6",  name: "Soute 6",  size: { x: 2, y: 8, z: 2 }, offset: { x: -4, y: 0,  z: 2 } },
      { id: "hull-b-bay-7",  name: "Soute 7",  size: { x: 2, y: 8, z: 2 }, offset: { x: -6, y: -9, z: 2 } },
      { id: "hull-b-bay-8",  name: "Soute 8",  size: { x: 2, y: 8, z: 2 }, offset: { x: -4, y: -9, z: 2 } },
      // Groupe droit (z=2)
      { id: "hull-b-bay-9",  name: "Soute 9",  size: { x: 2, y: 8, z: 2 }, offset: { x: 2,  y: 0,  z: 2 } },
      { id: "hull-b-bay-10", name: "Soute 10", size: { x: 2, y: 8, z: 2 }, offset: { x: 4,  y: 0,  z: 2 } },
      { id: "hull-b-bay-11", name: "Soute 11", size: { x: 2, y: 8, z: 2 }, offset: { x: 2,  y: -9, z: 2 } },
      { id: "hull-b-bay-12", name: "Soute 12", size: { x: 2, y: 8, z: 2 }, offset: { x: 4,  y: -9, z: 2 } },
      // Groupe bas (z=0)
      { id: "hull-b-bay-13", name: "Soute 13", size: { x: 2, y: 8, z: 2 }, offset: { x: -2, y: 0,  z: 0 } },
      { id: "hull-b-bay-14", name: "Soute 14", size: { x: 2, y: 8, z: 2 }, offset: { x: 0,  y: 0,  z: 0 } },
      { id: "hull-b-bay-15", name: "Soute 15", size: { x: 2, y: 8, z: 2 }, offset: { x: -2, y: -9, z: 0 } },
      { id: "hull-b-bay-16", name: "Soute 16", size: { x: 2, y: 8, z: 2 }, offset: { x: 0,  y: -9, z: 0 } },
    ],
  },
