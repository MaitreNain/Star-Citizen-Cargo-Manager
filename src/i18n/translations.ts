...
const translations = {
  fr: {
    ...
    "tuto.step0.title": "Bienvenue dans Cargo Planner",
    ...
    "tuto.step3.body": "Si tu connais déjà la composition exacte de ton chargement (taille et nombre de caisses), utilise le formulaire de chargement personnalisé.\n\nTu définis directement les caisses à charger, sans passer par un contrat de hauling. Idéal pour un chargement ponctuel ou un ajustement manuel.",
  ...
  en: {
    ...
    "tuto.next": "Next →",
    "tuto.finish": "✓ Done",
    "tuto.step0.title": "Welcome to Cargo Planner",
    ...
    "tuto.step3.body": "If you already know the exact composition of your load (crate sizes and quantities), use the custom load form.\n\nYou define the crates to load directly, without creating a hauling contract. Ideal for a one-off load or a manual adjustment.",
