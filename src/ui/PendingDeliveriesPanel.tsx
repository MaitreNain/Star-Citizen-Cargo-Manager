...
export default function PendingDeliveriesPanel({
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            padding: "8px 10px",
            background: bgColor,
            borderTop: `1px ${isWaiting ? "dashed" : "solid"} ${borderColor}`,
            borderRight: `1px ${isWaiting ? "dashed" : "solid"} ${borderColor}`,
            borderBottom: `1px ${isWaiting ? "dashed" : "solid"} ${borderColor}`,
  ...
  return (
    <div className="scifi-panel" style={{ marginBottom: "10px" }}>
      ...
      {/* Instruction sélection soute */}
      {isSelecting && (() => {
        const sel = items.find((i) => i.deliveryId === selectedDeliveryId);
        if (!sel || sel.state === "waiting") return null;
        if (sel.pendingScu <= 0) return null;
        return (
          <div style={{
        ...
        <div style={{ marginTop: "16px" }}>
          ...
          {archivedDeliveries.map((archived) => (
            <div key={archived.deliveryId} style={{
              ...
              <div style={{ width: "6px", height: "6px", borderRadius: "50%", background: "var(--success)", boxShadow: "0 0 5px var(--success)", flexShrink: 0 }} />
